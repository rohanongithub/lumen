...
const getProfileIcon = (user: string, isFriend: boolean = false) => {
  if (isFriend) {
    const friendImages = {
    ...
    return (
      <img 
        src={friendImages[user as keyof typeof friendImages]} 
        alt={user}
    ...
    <div className="min-h-screen pt-24 px-8">
      ...
      {replyTo && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/5 w-full max-w-md mx-4">
              ...
              >
                <div className="h-full flex flex-col">
                  ...
                  <div className="flex items-center space-x-6 mt-auto pt-4">
                    ...
                    >
                      {comment.isLiked ? (
                        <HeartIconSolid className="w-5 h-5 text-blue-500" />
                      ) : (
              ...
              {friendsList.map((friend) => (
                <div key={friend.id} className="flex items-start space-x-3">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden">
                    {getProfileIcon(friend.name, true)}
                  </div>
                  <div className="flex-1">
